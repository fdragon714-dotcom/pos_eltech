...
class InventoryLogAdmin(ModelAdmin):
    ...
    def movement_badge(self, obj):
        if obj.movement_type == "MASUK":
            return format_html('<span style="background:#dcfce7;color:#166534;padding:2px 10px;border-radius:20px;font-size:0.75rem;font-weight:600;">MASUK</span>')
        elif obj.movement_type == "KELUAR":
            return format_html('<span style="background:#fee2e2;color:#991b1b;padding:2px 10px;border-radius:20px;font-size:0.75rem;font-weight:600;">KELUAR</span>')
        else:
            return format_html('<span style="background:#fef3c7;color:#92400e;padding:2px 10px;border-radius:20px;font-size:0.75rem;font-weight:600;">PENYESUAIAN</span>')
